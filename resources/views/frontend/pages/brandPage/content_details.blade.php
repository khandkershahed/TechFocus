...
@section('content')
    ...
    {{-- Banner Section --}}
    @if(isset($newsTrend) && $newsTrend)
        <section>
            <div class="brand-page-banner page_top_banner">
                <img src="{{ $newsTrend->banner_image && file_exists(public_path('storage/' . $newsTrend->banner_image))
    ...
    @else
        <section>
            <div class="brand-page-banner page_top_banner">
                <img src="{{ asset('frontend/images/no-banner(1920-330).png') }}" alt="No banner available">
            </div>
        </section>
    @endif
