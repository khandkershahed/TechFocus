...
$(document).ready(function() {
    ...
    // =========================
    // Clear RFQ session on page load (refresh)
    // =========================
    ...
    $.validator.addMethod("customEmail", function(value, element) {
        return this.optional(element) || (value.indexOf('@') > 0 && value.indexOf('.') > value.indexOf('@') + 1);
    ...
    // =========================
    // Form submission with session clear
    // =========================
    $stepperForm.on('submit', function(e) {
        ...
        .then(data => {
            ...
            // Clear session/cart AFTER successful RFQ
            return fetch("/destroy-after-rfq", {
                method: "POST",
                headers: { 
                    "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr('content'),
                    "X-Requested-With": "XMLHttpRequest"
