    ...
    <div class="container">
                                ...
                                <li class="d-flex">
                                    <div>
                                        <span><i class="fa-regular fa-bookmark main_color pe-2"></i>
                                            {{ $solution->rowOne->list_one }}</span>
                                    </div>
                                </li>
                                <li class="d-flex">
                                    <div>
                                        <span><i class="fa-regular fa-bookmark main_color pe-2"></i>
                                            {{ $solution->rowOne->list_two }}</span>
                                    </div>
                                </li>
                                <li class="d-flex">
                                    <div>
                                        <span><i class="fa-regular fa-bookmark main_color pe-2"></i>
                                            {{ $solution->rowOne->list_three }}</span>
                                    </div>
                                </li>
                                <li class="d-flex">
                                    <div>
                                        <span><i class="fa-regular fa-bookmark main_color pe-2"></i>
                                            {{ $solution->rowOne->list_four }}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="my-4" style="background-color: #eee;">
            <div class="container py-lg-5 py-2">
                @php
                    $cards = [
                        $solution->solutionCardOne,
                        $solution->solutionCardTwo,
                        $solution->solutionCardThree,
                        $solution->solutionCardFour,
                    ];
                    $cardsections2 = [
                        $solution->solutionCardFive,
                        $solution->solutionCardSix,
                        $solution->solutionCardSeven,
                        $solution->solutionCardEight,
                    ];
                @endphp
        ...
        <section class="gradient_bg my-4">
            <div class="container">
                <div class="call_to_action_text py-sm-3">
                    ...
                    <p class="w-100 mx-auto solution_para mb-1">{{ $solution->row_three_header }}</p>
                </div>
            </div>
        </section>
        <!----------End--------->
