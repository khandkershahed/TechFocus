...
<div class="container-fluid">
    <div class="p-5 row breadcrumb-banner-area" style="
          background-image: url(https://virtual-expo.my.site.com/Visitors/s/sfsites/c/file-asset/Background1?v=1);
        ">
        <div class="col-lg-12">
            <h1 class="p-5 my-5 text-center font-poppins text-uppercase fw-bold">
                Welcome to the VirtualExpo <br />knowledge base
            </h1>
            {{-- <div class="pt-3 mx-auto col-lg-12 w-50">
                <form action="">
                    <div class="mb-3 input-group">
                        <input type="text" class="form-control rounded-pill" placeholder="Search ......"
                            aria-label="Recipient's username" />
                        <div class="input-group-append">
                            <button type="submit" class="w-auto btn signin rounded-pill faq-search">
...
<div class="container-fluid">
    <div class="p-5 row bg-light">
        <div class="col-lg-12">
            <h1 class="text-center titles">EXHIBIT WITH US</h1>
        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-sm-12">
                    <div class="p-5 card exhibition-card rounded-0">
                        <img src="https://img.directindustry.com/media/ps/images/di/carrefour/icon-fab.svg"
                            width="80px">
                        <h3 class="text-center titles">YOU ARE A PRINCIPAL</h3>
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="p-5 card exhibition-card rounded-0">
                        <img src="https://img.directindustry.com/media/ps/images/di/carrefour/icon-distributeur.svg"
                            width="80px">
                        <h3 class="text-center titles">PARTNER OR CLIENT</h3>
