                                    ...
                                    <a href="{{ route('solution.details', $solution->slug) }}">
                                        <div class="p-3 border-0 shadow-sm card rounded-0 solution_cards">
                                            <div class="py-0 pt-2 d-flex align-items-center card-body">
                                                <div class="icon-box">
                                                    @if($solution->icon)
                                                        <img width="70px" height="55px" src="{{ asset('storage/solutions/' . $solution->icon) }}" alt="{{ $solution->name }}" />
                                                    @else
                                                        <i class="fa-brands fa-draft2digital pe-2 main-color" style="font-size: 2rem;"></i>
                                                    @endif
                                                </div>
                                                <div class="text-box">
                                    ...
                                    <div class="p-3 border-0 shadow-sm card rounded-0 solution_cards">
                                        <div class="py-0 pt-2 d-flex align-items-center card-body">
                                            <div class="icon-box">
                                                ...
                                                @else
                                                <i class="fa-solid fa-cloud pe-2 main-color" style="font-size: 2rem;"></i>
                                                @endif
                                            </div>
                                            <div class="text-box">
                                                <p class="p-0 m-0 ps-2 w-75">
                                    ...
                                    <div class="p-3 border-0 shadow-sm card rounded-0 solution_cards">
                                        <div class="py-0 pt-2 d-flex align-items-center card-body">
                                            <div class="icon-box">
                                                ...
                                                @else
                                                <i class="fa-solid fa-shield-alt pe-2 main-color" style="font-size: 2rem;"></i>
                                                @endif
                                            </div>
                                            <div class="text-box">
                                                <p class="p-0 m-0 ps-2 w-75">
                                    ...
                                    <div class="p-3 border-0 shadow-sm card rounded-0 solution_cards">
                                        <div class="py-0 pt-2 d-flex align-items-center card-body">
                                            <div class="icon-box">
                                                ...
                                                @else
                                                <i class="fa-solid fa-network-wired pe-2 main-color" style="font-size: 2rem;"></i>
                                                @endif
                                            </div>
                                            <div class="text-box">
                                                <p class="p-0 m-0 ps-2 w-75">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="holder-main-text">
                        ...
                        <a href="{{ $homePage->section_seven_link }}" class="mt-4 btn common-btn-3 rounded-0 w-25">
