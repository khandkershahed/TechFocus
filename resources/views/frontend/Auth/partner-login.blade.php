                        ...
                        <form action="{{ route('partner.login.submit') }}" method="POST" class="login-validation" novalidate>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="email" class="form-control rounded-0" id="email"
                                       placeholder="Enter Partner Email" name="email" required>
                            ...
                            <div class="row pb-3 d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    @if (Route::has('password.request'))
                                        <p><a href="{{ route('password.request') }}" class="my-3 main-color fs-7">Forgot Your Password?</a></p>
                                    @endif
                                </div>
                                <div>
                                    <p class="fs-7">Not a Partner Yet? <a href="{{ route('register') }}" class="my-3 main-color fw-bold">Sign Up as Client</a></p>
                                </div>
                            </div>

                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn common-btn-3 rounded-0 w-auto">Login as Partner</button>
                            </div>
                        </form>
                    </div>
                </div>
