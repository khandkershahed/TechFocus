...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									...
									<div class="menu-item">
										<div class="menu-content">
											<a class="p-0 mb-2 btn btn-flex btn-color-success fs-base ms-2 collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_aside_menu_collapse" data-kt-toggle-text="Show Less">
												<span data-kt-toggle-text-target="true">Show 10 More</span>
												<!--begin::Svg Icon | path: icons/duotune/arrows/arr082.svg-->
												<span class="rotate-180 svg-icon ms-2 svg-icon-3">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									...
									<div class="my-5 menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
										<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
												...
												<div class="menu-item">
													<a class="py-3 menu-link" href="../../demo1/dist/dashboards/projects.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Projects</span>
												...
												<div class="menu-item">
													<a class="py-3 menu-link" href="../../demo1/dist/dashboards/online-courses.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Online Courses</span>
												...
												<div class="menu-item">
													<a class="py-3 menu-link" href="../../demo1/dist/dashboards/bidding.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Bidding</span>
												...
												<div class="menu-inner flex-column collapse" id="kt_aside_menu_collapse_2">
													...
													<div class="menu-item">
														<a class="py-3 menu-link" href="../../demo1/dist/dashboards/website-analytics.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Website Analytics</span>
													...
													<div class="menu-item">
														<a class="py-3 menu-link" href="../../demo1/dist/dashboards/finance-performance.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Finance Performance</span>
													...
													<div class="menu-item">
														<a class="py-3 menu-link" href="../../demo1/dist/dashboards/crypto.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Crypto</span>
													...
													<div class="menu-item">
														<a class="py-3 menu-link" href="../../demo1/dist/dashboards/school.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">School</span>
													...
													<div class="menu-item">
														<a class="py-3 menu-link" href="../../demo1/dist/dashboards/podcast.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Podcast</span>
												...
												<div class="menu-item">
													<div class="menu-content">
														<a class="p-0 mb-2 btn btn-flex btn-color-success fs-base ms-2 collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_aside_menu_collapse_2" data-kt-toggle-text="Show Less">
															<span data-kt-toggle-text-target="true">Show 10 More</span>
															<!--begin::Svg Icon | path: icons/duotune/arrows/arr082.svg-->
															<span class="rotate-180 svg-icon ms-2 svg-icon-3">
																<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
															...
															<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																...
																<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
																	...
																	<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																		...
																		<div class="menu-item">
																			<a class="py-3 menu-link" href="../../demo1/dist/utilities/modals/forms/bidding.html">
																				<span class="menu-bullet">
																					<span class="bullet bullet-dot"></span>
																				</span>
																				<span class="menu-title">Bidding</span>
										...
										<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
														...
														<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
															...
															<div class="menu-sub menu-sub-accordion">
																<div class="menu-item">
																	<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/customers/listing.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
																...
																<div class="menu-item">
																	<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/customers/details.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
														...
														<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
															...
															<div class="menu-sub menu-sub-accordion">
																<div class="menu-item">
																	<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/view.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
																		<span class="menu-title">Products Viewed</span>
																...
																<div class="menu-item">
																	<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/sales.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
																		<span class="menu-title">Sales</span>
																...
																<div class="menu-item">
																	<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/returns.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
																		<span class="menu-title">Returns</span>
																...
																<div class="menu-item">
																	<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/customer-orders.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
																		<span class="menu-title">Customer Orders</span>
																...
																<div class="menu-item">
																	<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/reports/shipping.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
																		<span class="menu-title">Shipping</span>
														...
														<div class="menu-item">
															<a class="py-3 menu-link" href="../../demo1/dist/apps/ecommerce/settings.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Settings</span>
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
														<div class="menu-item">
															<a class="py-3 menu-link" href="../../demo1/dist/apps/contacts/getting-started.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Getting Started</span>
														...
														<div class="menu-item">
															<a class="py-3 menu-link" href="../../demo1/dist/apps/contacts/add-contact.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Add Contact</span>
														...
														<div class="menu-item">
															<a class="py-3 menu-link" href="../../demo1/dist/apps/contacts/edit-contact.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Edit Contact</span>
														...
														<div class="menu-item">
															<a class="py-3 menu-link" href="../../demo1/dist/apps/contacts/view-contact.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">View Contact</span>
							...
							<div class="flex-shrink-0 d-flex align-items-stretch">
								...
								<div class="d-flex align-items-center ms-1 ms-lg-3">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
										<!--begin::Heading-->
										<div class="py-10 d-flex flex-column flex-center bgi-no-repeat rounded-top px-9" style="background-image:url('assets/media/misc/pattern-1.jpg')">
											<!--begin::Title-->
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="flex-wrap mb-5 page-title d-flex align-items-center me-3 mb-lg-0">
									<!--begin::Title-->
									<h1 class="my-1 d-flex text-dark fw-bolder fs-3 align-items-center">Dashboard
									<!--begin::Separator-->
									<span class="mx-2 border-gray-200 h-20px border-1 border-start ms-3 me-1"></span>
									<!--end::Separator-->
									<!--begin::Description-->
									<span class="mt-2 text-muted fs-7 fw-bold">#XRS-45670</span>
									<!--end::Description--></h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
					...
					<div class="timeline">
						...
						<div class="timeline-item">
							...
							<div class="mb-10 timeline-content mt-n1">
								...
								<div class="mb-5 pe-3">
									<!--begin::Title-->
									<div class="mb-2 fs-5 fw-bold">There are 2 new tasks for you in “AirPlus Mobile App” project:</div>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="timeline-item">
							...
							<div class="mb-10 timeline-content mt-n2">
								...
								<div class="overflow-auto pe-3">
									<!--begin::Title-->
									<div class="mb-2 fs-5 fw-bold">Invitation for crafting engaging designs that speak human workshop</div>
									<!--end::Title-->
									<!--begin::Description-->
									<div class="mt-1 d-flex align-items-center fs-6">
										<!--begin::Info-->
						...
						<div class="timeline-item">
							...
							<div class="mb-10 timeline-content mt-n1">
								...
								<div class="mb-5 pe-3">
									<!--begin::Title-->
									<a href="#" class="mb-2 text-gray-800 fs-5 fw-bold text-hover-primary">3 New Incoming Project Files:</a>
									<!--end::Title-->
									<!--begin::Description-->
									<div class="mt-1 d-flex align-items-center fs-6">
										<!--begin::Info-->
						...
						<div class="timeline-item">
							...
							<div class="mb-10 timeline-content mt-n1">
								...
								<div class="mb-5 pe-3">
									<!--begin::Title-->
									<div class="mb-2 fs-5 fw-bold">Task
						...
						<div class="timeline-item">
							...
							<div class="mb-10 timeline-content mt-n1">
								...
								<div class="mb-5 pe-3">
									<!--begin::Title-->
									<div class="mb-2 fs-5 fw-bold">3 new application design concepts added:</div>
									<!--end::Title-->
									<!--begin::Description-->
									<div class="mt-1 d-flex align-items-center fs-6">
										<!--begin::Info-->
						...
						<div class="timeline-item">
							...
							<div class="mb-10 timeline-content mt-n1">
								...
								<div class="mb-5 pe-3">
									<!--begin::Title-->
									<div class="mb-2 fs-5 fw-bold">New case
						...
						<div class="timeline-item">
							...
							<div class="mb-10 timeline-content mt-n1">
								...
								<div class="mb-5 pe-3">
									<!--begin::Title-->
									<div class="mb-2 fs-5 fw-bold">You have received a new order:</div>
									<!--end::Title-->
									<!--begin::Description-->
									<div class="mt-1 d-flex align-items-center fs-6">
										<!--begin::Info-->
						...
						<div class="timeline-item">
							...
							<div class="timeline-content mt-n1">
								...
								<div class="mb-5 pe-3">
									<!--begin::Title-->
									<div class="mb-2 fs-5 fw-bold">New order
			...
			<div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
				...
				<div class="card-title">
					...
					<div class="d-flex justify-content-center flex-column me-3">
						<a href="#" class="mb-2 text-gray-900 fs-4 fw-bolder text-hover-primary me-1 lh-1">Brian Cox</a>
						<!--begin::Info-->
						<div class="mb-0 lh-1">
					...
					<div class="mb-10 d-flex justify-content-start">
						...
						<div class="d-flex flex-column align-items-start">
							...
							<div class="mb-2 d-flex align-items-center">
								...
								<!--begin::Details-->
								<div class="ms-3">
									<a href="#" class="text-gray-900 fs-5 fw-bolder text-hover-primary me-1">Brian Cox</a>
	...
	<div id="kt_engage_demos" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="explore" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'350px', 'lg': '475px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_engage_demos_toggle" data-kt-drawer-close="#kt_engage_demos_close">
		<!--begin::Card-->
		<div class="shadow-none card rounded-0 w-100">
			<!--begin::Header-->
			<div class="card-header" id="kt_engage_demos_header">
				<h3 class="text-gray-700 card-title fw-bolder">Explore</h3>
				<div class="card-toolbar">
			...
			<div class="card-body" id="kt_engage_demos_body">
				...
				<div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
					...
					<div class="mb-0">
						...
						<!--end::Heading-->
						<!--begin::License-->
						<div class="px-6 py-4 mb-5 border border-gray-300 border-dashed rounded">
							<div class="d-flex flex-stack">
								<div class="d-flex flex-column">
									<div class="mb-1 d-flex align-items-center">
										<div class="mb-0 text-gray-800 fs-6 fw-bold me-1">Regular License</div>
						...
						<div class="px-6 py-4 mb-5 border border-gray-300 border-dashed rounded">
							<div class="d-flex flex-stack">
								<div class="d-flex flex-column">
									<div class="mb-1 d-flex align-items-center">
										<div class="mb-0 text-gray-800 fs-6 fw-bold me-1">Extended License</div>
						...
						<div class="px-6 py-4 mb-5 border border-gray-300 border-dashed rounded">
							<div class="d-flex flex-stack">
								<div class="d-flex flex-column">
									<div class="mb-1 d-flex align-items-center">
										<div class="mb-0 text-gray-800 fs-6 fw-bold me-1">Custom License</div>
									</div>
						...
						<!--begin::Demos-->
						<div class="mb-0">
							<h3 class="mb-6 text-center fw-bolder">Metronic Demos</h3>
							<!--begin::Row-->
							<div class="row g-5">
								<!--begin::Col-->
								<div class="col-6">
									<!--begin::Demo-->
									<div class="overflow-hidden border border-4 rounded overlay position-relative border-success">
										<div class="overlay-wrapper">
											<img src="assets/media/demos/demo1.png" alt="demo" class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo1" class="shadow btn btn-sm btn-success">Demo 1</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									<!--begin::Demo-->
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										<div class="overlay-wrapper">
											<img src="assets/media/demos/demo2.png" alt="demo" class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo2" class="shadow btn btn-sm btn-success">Demo 2</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo3" class="shadow btn btn-sm btn-success">Demo 3</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo4" class="shadow btn btn-sm btn-success">Demo 4</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo5" class="shadow btn btn-sm btn-success">Demo 5</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo6" class="shadow btn btn-sm btn-success">Demo 6</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo7" class="shadow btn btn-sm btn-success">Demo 7</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo8" class="shadow btn btn-sm btn-success">Demo 8</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo9" class="shadow btn btn-sm btn-success">Demo 9</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo10" class="shadow btn btn-sm btn-success">Demo 10</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo11" class="shadow btn btn-sm btn-success">Demo 11</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo12" class="shadow btn btn-sm btn-success">Demo 12</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo13" class="shadow btn btn-sm btn-success">Demo 13</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo14" class="shadow btn btn-sm btn-success">Demo 14</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo15" class="shadow btn btn-sm btn-success">Demo 15</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo16" class="shadow btn btn-sm btn-success">Demo 16</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo17" class="shadow btn btn-sm btn-success">Demo 17</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo18" class="shadow btn btn-sm btn-success">Demo 18</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo19" class="shadow btn btn-sm btn-success">Demo 19</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo20" class="shadow btn btn-sm btn-success">Demo 20</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo21" class="shadow btn btn-sm btn-success">Demo 21</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo22" class="shadow btn btn-sm btn-success">Demo 22</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										<div class="overlay-wrapper">
											<img src="assets/media/demos/demo23.png" alt="demo" class="opacity-25 w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
										<div class="overlay-wrapper">
											<img src="assets/media/demos/demo24.png" alt="demo" class="opacity-25 w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
										</div>
	...
	<div id="kt_help" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="help" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'350px', 'md': '525px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_help_toggle" data-kt-drawer-close="#kt_help_close">
		...
		<div class="shadow-none card rounded-0 w-100">
			...
			<div class="card-header" id="kt_help_header">
				<h5 class="text-gray-600 card-title fw-bold">Learn &amp; Get Inspired</h5>
				<div class="card-toolbar">
			...
			<div class="card-body" id="kt_help_body">
				...
				<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
					<!--begin::Support-->
					<div class="p-6 mb-10 border border-gray-300 border-dashed rounded p-lg-8">
						<!--begin::Heading-->
						<h2 class="mb-5 fw-bolder">Support at
							<a href="https://devs.keenthemes.com" class="">devs.keenthemes.com</a>
						</h2>
						<!--end::Heading-->
						<!--begin::Description-->
						<div class="mb-5 fs-5 fw-bold">
					...
					<div class="d-flex align-items-center mb-7">
						<!--begin::Icon-->
						<div class="flex-shrink-0 rounded d-flex flex-center w-50px h-50px w-lg-75px h-lg-75px bg-light-warning">
							<!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
						...
						<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
							...
							<div class="d-flex flex-column me-2 me-lg-5">
								<!--begin::Title-->
								<a href="../../demo1/dist/documentation/getting-started.html" class="mb-1 text-dark text-hover-primary fw-bolder fs-6 fs-lg-4">Documentation &amp; Videos</a>
								<!--end::Title-->
								<!--begin::Description-->
					...
					<div class="d-flex align-items-center mb-7">
						<!--begin::Icon-->
						<div class="flex-shrink-0 rounded d-flex flex-center w-50px h-50px w-lg-75px h-lg-75px bg-light-primary">
							<!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
						...
						<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
							...
							<div class="d-flex flex-column me-2 me-lg-5">
								<!--begin::Title-->
								<a href="../../demo1/dist/documentation/base/utilities.html" class="mb-1 text-dark text-hover-primary fw-bolder fs-6 fs-lg-4">Plugins &amp; Components</a>
								<!--end::Title-->
								<!--begin::Description-->
					...
					<div class="d-flex align-items-center mb-7">
						<!--begin::Icon-->
						<div class="flex-shrink-0 rounded d-flex flex-center w-50px h-50px w-lg-75px h-lg-75px bg-light-info">
						...
						<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
							...
							<div class="d-flex flex-column me-2 me-lg-5">
								<!--begin::Title-->
								<a href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" class="mb-1 text-dark text-hover-primary fw-bolder fs-6 fs-lg-4">Layout Builder</a>
								<!--end::Title-->
								<!--begin::Description-->
					...
					<div class="d-flex align-items-center mb-7">
						<!--begin::Icon-->
						<div class="flex-shrink-0 rounded d-flex flex-center w-50px h-50px w-lg-75px h-lg-75px bg-light-success">
						...
						<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
							...
							<div class="d-flex flex-column me-2 me-lg-5">
								<!--begin::Title-->
								<a href="https://devs.keenthemes.com/metronic" class="mb-1 text-dark text-hover-primary fw-bolder fs-6 fs-lg-4">Metronic Downloads</a>
								<!--end::Title-->
								<!--begin::Description-->
					...
					<div class="d-flex align-items-center mb-7">
						<!--begin::Icon-->
						<div class="flex-shrink-0 rounded d-flex flex-center w-50px h-50px w-lg-75px h-lg-75px bg-light-danger">
						...
						<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
							...
							<div class="d-flex flex-column me-2 me-lg-5">
								<!--begin::Title-->
								<a href="../../demo1/dist/documentation/getting-started/changelog.html" class="mb-1 text-dark text-hover-primary fw-bolder fs-6 fs-lg-4">What's New</a>
								<!--end::Title-->
								<!--begin::Description-->
	...
	<div class="gap-2 px-5 mt-20 engage-toolbar d-flex position-fixed fw-bolder zindex-2 top-50 end-0 transform-90">
		<!--begin::Demos drawer toggle-->
		<button id="kt_engage_demos_toggle" class="px-4 shadow-sm engage-demos-toggle btn btn-flex h-35px bg-body btn-color-gray-700 btn-active-color-gray-900 fs-6 rounded-top-0" title="Check out 22 more demos" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
			<span id="kt_engage_demos_label">Demos</span>
		</button>
		<!--end::Demos drawer toggle-->
		<!--begin::Help drawer toggle-->
		<button id="kt_help_toggle" class="px-5 shadow-sm engage-help-toggle btn btn-flex h-35px bg-body btn-color-gray-700 btn-active-color-gray-900 rounded-top-0" title="Learn &amp; Get Inspired" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">Help</button>
						...
						<div class="mt-10 row">
							...
							<div class="mb-10 col-lg-6 mb-lg-0">
								...
								<div class="nav flex-column">
									<!--begin::Tab link-->
									<div class="p-6 mb-6 nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start active" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
										<!--end::Description-->
										<div class="d-flex align-items-center me-2">
											<!--begin::Radio-->
											...
											<!--begin::Info-->
											<div class="flex-grow-1">
												<h2 class="flex-wrap d-flex align-items-center fs-2 fw-bolder">Startup</h2>
												<div class="opacity-50 fw-bold">Best for startups</div>
											</div>
											<!--end::Info-->
										</div>
										<!--end::Description-->
									...
									<!--end::Tab link-->
									<!--begin::Tab link-->
									<div class="p-6 mb-6 nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_advanced">
										<!--end::Description-->
										<div class="d-flex align-items-center me-2">
											<!--begin::Radio-->
											<div class="form-check form-check-custom form-check-solid form-check-success me-6">
											...
											<!--begin::Info-->
											<div class="flex-grow-1">
												<h2 class="flex-wrap d-flex align-items-center fs-2 fw-bolder">Advanced</h2>
												<div class="opacity-50 fw-bold">Best for 100+ team size</div>
											</div>
											<!--end::Info-->
										</div>
										<!--end::Description-->
									...
									<!--end::Tab link-->
									<!--begin::Tab link-->
									<div class="p-6 mb-6 nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_enterprise">
										<!--end::Description-->
										<div class="d-flex align-items-center me-2">
											<!--begin::Radio-->
											<div class="form-check form-check-custom form-check-solid form-check-success me-6">
											...
											<!--begin::Info-->
											<div class="flex-grow-1">
												<h2 class="flex-wrap d-flex align-items-center fs-2 fw-bolder">Enterprise
													<span class="badge badge-light-success ms-2 fs-7">Most popular</span>
												</h2>
												<div class="opacity-50 fw-bold">Best value for 1000+ team</div>
											</div>
											<!--end::Info-->
										</div>
										<!--end::Description-->
									...
									<!--end::Tab link-->
									<!--begin::Tab link-->
									<div class="p-6 nav-link btn btn-outline btn-outline-dashed btn-color-dark d-flex flex-stack text-start">
										<!--end::Description-->
										<div class="d-flex align-items-center me-2">
											<!--begin::Radio-->
											<div class="form-check form-check-custom form-check-solid form-check-success me-6">
											...
											<!--begin::Info-->
											<div class="flex-grow-1">
												<h2 class="flex-wrap d-flex align-items-center fs-2 fw-bolder">Custom</h2>
												<div class="opacity-50 fw-bold">Requet a custom license</div>
											</div>
											<!--end::Info-->
										</div>
										<!--end::Description-->
								...
								<div class="p-10 rounded tab-content h-100 bg-light">
									...
									<div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
										...
										<div class="pt-1">
											<!--begin::Item-->
											<div class="d-flex align-items-center mb-7">
												<span class="text-gray-700 fw-bold fs-5 flex-grow-1">Up to 10 Active Users</span>
											...
											<!--begin::Item-->
											<div class="d-flex align-items-center mb-7">
												<span class="text-gray-700 fw-bold fs-5 flex-grow-1">Up to 30 Project Integrations</span>
												<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
												<span class="svg-icon svg-icon-1 svg-icon-success">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
											...
											<!--begin::Item-->
											<div class="d-flex align-items-center mb-7">
												<span class="text-gray-700 fw-bold fs-5 flex-grow-1">Analytics Module</span>
												<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
												<span class="svg-icon svg-icon-1 svg-icon-success">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
									...
									<div class="tab-pane fade" id="kt_upgrade_plan_advanced">
										...
										<div class="pt-1">
											...
											<!--begin::Item-->
											<div class="d-flex align-items-center mb-7">
												<span class="text-gray-700 fw-bold fs-5 flex-grow-1">Finance Module</span>
												<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
												<span class="svg-icon svg-icon-1 svg-icon-success">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
											...
											<!--begin::Item-->
											<div class="d-flex align-items-center mb-7">
												<span class="text-gray-700 fw-bold fs-5 flex-grow-1">Accounting Module</span>
												<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
												<span class="svg-icon svg-icon-1 svg-icon-success">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
									...
									<div class="tab-pane fade" id="kt_upgrade_plan_enterprise">
										...
										<div class="pt-1">
											...
											<!--begin::Item-->
											<div class="d-flex align-items-center mb-7">
												<span class="text-gray-700 fw-bold fs-5 flex-grow-1">Network Platform</span>
												<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
												<span class="svg-icon svg-icon-1 svg-icon-success">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
											...
											<!--begin::Item-->
											<div class="d-flex align-items-center">
												<span class="text-gray-700 fw-bold fs-5 flex-grow-1">Unlimited Cloud Space</span>
												<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
												<span class="svg-icon svg-icon-1 svg-icon-success">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
							...
							<form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
								...
								<div class="current" data-kt-stepper-element="content">
									<div class="w-100">
										...
										<div class="mb-10 fv-row">
											<!--begin::Label-->
											<label class="mb-2 d-flex align-items-center fs-5 fw-bold">
										...
										<div class="fv-row">
											<!--begin::Label-->
											<label class="mb-4 d-flex align-items-center fs-5 fw-bold">
								...
								<div data-kt-stepper-element="content">
									<div class="w-100">
										...
										<div class="mb-10 fv-row">
											<!--begin::Label-->
											<label class="mb-2 required fs-5 fw-bold">Database Name</label>
											<!--end::Label-->
											<!--begin::Input-->
								...
								<div data-kt-stepper-element="content">
									<div class="w-100">
										...
										<div class="d-flex flex-column mb-7 fv-row">
											<!--begin::Label-->
											<label class="mb-2 d-flex align-items-center fs-6 fw-bold form-label">
										...
										<div class="d-flex flex-column mb-7 fv-row">
											<!--begin::Label-->
											<label class="mb-2 required fs-6 fw-bold form-label">Card Number</label>
											<!--end::Label-->
											<!--begin::Input wrapper-->
										...
										<div class="mb-10 row">
											...
											<div class="col-md-8 fv-row">
												<!--begin::Label-->
												<label class="mb-2 required fs-6 fw-bold form-label">Expiration Date</label>
												<!--end::Label-->
												<!--begin::Row-->
								...
								<div data-kt-stepper-element="content">
									<div class="text-center w-100">
										<!--begin::Heading-->
										<h1 class="mb-3 fw-bolder text-dark">Release!</h1>
										<!--end::Heading-->
										<!--begin::Description-->
		...
		<div class="modal-dialog mw-650px">
			...
			<div class="modal-content">
				...
				<div class="pt-0 mx-5 modal-body scroll-y mx-xl-18 pb-15">
					...
					<div class="mb-8 btn btn-light-primary fw-bolder w-100">
					...
					<div class="mb-8 separator d-flex flex-center">
						<span class="px-3 text-uppercase bg-body fs-7 fw-bold text-muted">or</span>
					</div>
					<!--end::Separator-->
					<!--begin::Textarea-->
					...
					<div class="mb-10">
						<!--begin::Heading-->
						<div class="mb-2 fs-6 fw-bold">Your Invitations</div>
						<!--end::Heading-->
						<!--begin::List-->
						<div class="mh-300px scroll-y me-n7 pe-7">
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Emma Smith</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Melody Macy</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Max Smith</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Sean Bean</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Brian Cox</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Mikaela Collins</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Francis Mitcham</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Olivia Wild</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Neil Owen</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Dan Wilson</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Emma Bold</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Ana Crown</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Robert Doe</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">John Miller</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Lucy Kunic</a>
							...
							<div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Details-->
									<div class="ms-5">
										<a href="#" class="mb-2 text-gray-900 fs-5 fw-bolder text-hover-primary">Ethan Wilder</a>
					...
					<div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="inline">
						...
						<div class="py-5">
							...
							<div data-kt-search-element="suggestions">
								<!--begin::Heading-->
								<h3 class="mb-5 fw-bold">Recently searched:</h3>
								<!--end::Heading-->
								<!--begin::Users-->
