...
<head>
	...
	<style>
		...
		.bg-cyan-50 { background-color: rgba(13, 202, 240, 0.1); }
		.bg-cyan-100 { background-color: rgba(13, 202, 240, 0.2); }
		.text-cyan-600 { color: #0891b2; }
		.text-cyan-700 { color: #0e7490; }
		.border-cyan-100 { border-color: rgba(13, 202, 240, 0.2); }
		
		.bg-slate-50 { background-color: #f8f9fa; }
		.bg-slate-100 { background-color: #e9ecef; }
		.text-slate-500 { color: #6c757d; }
		.text-slate-600 { color: #495057; }
		.text-slate-700 { color: #343a40; }
		.text-slate-800 { color: #212529; }
		.text-slate-900 { color: #1a1a1a; }
		.border-slate-100 { border-color: #dee2e6; }
		.border-slate-200 { border-color: #ced4da; }
		.border-slate-300 { border-color: #adb5bd; }

		.bg-emerald-100 { background-color: rgba(16, 185, 129, 0.2); }
		.text-emerald-700 { color: #047857; }

		.bg-purple-100 { background-color: rgba(168, 85, 247, 0.2); }
		.text-purple-600 { color: #9333ea; }

		.bg-amber-100 { background-color: rgba(245, 158, 11, 0.2); }
		.text-amber-800 { color: #92400e; }

		/* Hover states */
		.hover-bg-slate-50:hover { background-color: #f8f9fa; }
		.hover-bg-slate-100:hover { background-color: #e9ecef; }
		.hover-scale:hover { transform: scale(1.02); }

		/* Border colors */
		.border-t-4 { border-top-width: 4px; }
		.border-t-cyan-500 { border-top-color: #0dcaf0; }
		.border-t-green-500 { border-top-color: #198754; }
		.border-t-purple-500 { border-top-color: #6f42c1; }
