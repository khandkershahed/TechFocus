        ...
        <div class="pt-2 card-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="border rounded shadow-sm border-light card card-flush">
                        <div class="p-3 card-header d-flex justify-content-between align-items-center">
                            <h3 class="text-black card-title fw-bold ps-3">
                                <i class="text-black fas fa-address-card fs-1 me-2"></i> Addresses & Offices
                            </h3>
                ...
                <div class="mt-5 col-lg-4">
                    @if($latestBrand)
                    <div class="p-5 border rounded shadow-sm border-light card card-flush">
                        <h3 class="mb-5 text-black card-title fw-bold">
