                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                            ...
                            <div
                                ...
                                <div class="menu-inner flex-column collapse" id="kt_aside_menu_collapse_2">
                                    <div class="menu-item">
                                        <a class="menu-link py-3" href="{{ route('principal.notes.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    @if(Auth::guard('principal')->user()->company_name)
                                        <span class="fw-bold text-muted fs-8 mt-1">{{ Auth::guard('principal')->user()->company_name }}</span>
                                    @endif
                                </div>
                        ...
                        {{-- <div class="menu-item px-5">
                            <a href="{{ route('principal.profile.index') }}" class="menu-link px-5">My Profile</a>
                        </div>
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ route('principal.profile.settings') }}" class="menu-link px-5">Account Settings</a>
                        </div> --}}
