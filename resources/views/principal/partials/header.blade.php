                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                            ...
                            <div
                                ...
                                <div class="menu-inner flex-column collapse" id="kt_aside_menu_collapse_2">
                                    <div class="menu-item">
                                        <a class="py-3 menu-link" href="{{ route('principal.notes.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                ...
                                <div class="menu-item">
                                    <div class="menu-content">
                                        <a class="p-0 mb-2 btn btn-flex btn-color-success fs-base ms-2 collapsible collapsed rotate"
            ...
            <div class="flex-shrink-0 d-flex align-items-stretch">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        @if(Auth::guard('principal')->user()->photo)
                        <img src="{{ asset('storage/' . Auth::guard('principal')->user()->photo) }}" alt="Principal" />
                        @else
                        <img src="{{ asset('backend') }}/assets/media/avatars/300-1.jpg" alt="Principal" />
                        @endif
                    </div>
                    ...
                    <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold fs-6 w-275px"
                        ...
                        <div class="px-3 menu-item">
                            <div class="px-3 menu-content d-flex align-items-center">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    @if(Auth::guard('principal')->user()->photo)
                                    <img alt="Logo" src="{{ asset('storage/' . Auth::guard('principal')->user()->photo) }}" />
                                    @else
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5">
                                        ...
                                        <span class="px-2 py-1 badge badge-light-primary fw-bolder fs-8 ms-2">
                                            @if(Auth::guard('principal')->user()->client_type)
                                            {{ ucfirst(Auth::guard('principal')->user()->client_type) }}
                                            @else
                                            Principal
                                            @endif
                                        </span>
                                    ...
                                    <a href="#"
                                        class="fw-bold text-muted text-hover-primary fs-7">{{ Auth::guard('principal')->user()->email }}</a>
                                    @if(Auth::guard('principal')->user()->company_name)
                                    <span class="mt-1 fw-bold text-muted fs-8">{{ Auth::guard('principal')->user()->company_name }}</span>
                                    @endif
                                </div>
                        ...
                        {{-- <div class="px-5 menu-item">
                            <a href="{{ route('principal.profile.index') }}" class="px-5 menu-link">My Profile</a>
                    </div>
                    ...
                    <div class="px-5 my-1 menu-item">
                        <a href="{{ route('principal.profile.settings') }}" class="px-5 menu-link">Account Settings</a>
                    </div> --}}
                    ...
                    <div class="px-5 menu-item">
                        <form action="{{ route('principal.logout') }}" method="post">
                            @csrf
                            <a href="javascript:void(0);" class="px-5 menu-link"
