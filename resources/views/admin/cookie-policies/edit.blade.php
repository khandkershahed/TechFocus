...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-gray-800">Edit Cookie Policy</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Policy: {{ $cookiePolicy->title }}</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.cookie-policies.update', $cookiePolicy) }}" method="POST" id="policyForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="title" 
                                   name="title" 
                                   value="{{ old('title', $cookiePolicy->title) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="content" id="hiddenContent" 
                                   value="{{ old('content', $cookiePolicy->content) }}">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" 
                                               ...
                                               name="is_active" 
                                               value="1"
                                               {{ old('is_active', $cookiePolicy->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <h6 class="font-weight-bold">Policy Information</h6>
                                    <ul class="list-unstyled text-muted">
                                        ...
                                        <li>
                                            ...
                                            Last Updated: {{ $cookiePolicy->updated_at->diffForHumans() }}
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
quill.root.innerHTML = `{!! old('content', $cookiePolicy->content) !!}`;
...
function previewContent() {
    const title = document.getElementById('title').value || '{{ $cookiePolicy->title }}';
