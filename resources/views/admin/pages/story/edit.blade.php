        ...
        <div class="row">
            <div class="col-lg-12 card rounded-0 shadow-sm px-0">
                <div class="card card-flush">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-sm-12 text-lg-start text-sm-center">
                                    <div class="card-title ps-3">
                                        <h2 class="text-start ps-5">Client Story Edit Form</h2>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.story.update', $content->id) }}" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="fv-row mb-3">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="brand_id[]"
                                            id="brandSelect" multiple multiselect-search="true" multiselect-select-all="true"
                                            multiselect-max-items="2">
                                            @php
                                                // Safe JSON decoding with fallback
                                                $brandIds = [];
                                                if (isset($content->brand_id) && !empty($content->brand_id)) {
                                    ...
                                    <div class="fv-row mb-3">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="category_id[]"
                                            id="categorySelect" multiple multiselect-search="true" multiselect-select-all="true">
                                            @php
                                                $categoryIds = [];
                                    ...
                                    <div class="fv-row mb-3 mt-1">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="industry_id[]"
                                            id="industrySelect" multiple multiselect-search="true" multiselect-select-all="true"
                                            multiselect-max-items="2">
                                            @php
                                                $industryIds = [];
                                                if (isset($content->industry_id) && !empty($content->industry_id)) {
                                    ...
                                    <div class="fv-row mb-3 mt-1">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="solution_id[]"
                                            id="solutionSelect" multiple multiselect-search="true" multiselect-select-all="true"
                                            multiselect-max-items="2">
                                            @php
                                                $solutionIds = [];
                                                if (isset($content->solution_id) && !empty($content->solution_id)) {
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            <label for="validationCustom01" class="form-label">Additional Button Name</label>
                                            <input type="text" class="form-control form-control-solid form-control-sm"
                                                id="validationCustom01" placeholder="Enter Additional Button Name"
                                                name="additional_button_name" value="{{ $content->additional_button_name }}">
                                            <div class="invalid-feedback"> Please Enter Additional Button Name</div>
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="validationCustom01" class="form-label">Additional Button URL</label>
                                            <input type="url" class="form-control form-control-solid form-control-sm"
                                                id="validationCustom01" placeholder="Enter Additional URL"
