            ...
            <div class="bg-white border-0 shadow-none card rounded-0">
                ...
                <div class="flex-wrap px-4 py-3 card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="mb-3 text-end">
                        <button type="button" class="shadow-sm btn btn-success btn-sm rounded-1"
                            data-bs-toggle="modal" data-bs-target="#adminAddModal">
                                ...
                                <tr class="border">
                                    ...
                                    <td>
                                        ...
                                        : asset('backend/images/no-image-available.png') }}"
                                            alt="{{ $admin->name }}"
                                            class="border img-fluid rounded-circle" width="45" height="45">
                                    </td>
                                    <td>{{ $admin->name }}</td>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-light-success text-success fw-semibold">{{ ucfirst($department) }}</span>
                                        @endforeach
                                        @else
                                        <span class="badge bg-light-success text-success fw-semibold">{{ ucfirst($admin->department) }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <span class="badge bg-light-primary text-primary">{{ ucfirst($admin->role ?? 'N/A') }}</span>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.employee.create') }}" class="btn btn-sm btn-light-primary">
...
<div class="modal fade" id="adminAddModal" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="border-0 shadow-sm modal-content rounded-3">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('admin.employee.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control form-control-solid" placeholder="Enter Full Name">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" name="designation" value="{{ old('designation') }}" class="form-control form-control-solid" placeholder="Enter Designation">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" name="phone" value="{{ old('phone') }}" class="form-control form-control-solid" placeholder="Enter Phone Number">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                ...
                                <select name="employee_category_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select Job Category">
                                    <option></option>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" name="employee_id" value="{{ old('employee_id') }}" class="form-control form-control-solid" placeholder="Employee Code">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="">
                                ...
                                <select name="department[]" class="form-select form-select-solid"
                                    ...
                                    data-placeholder="Select departments" data-allow-clear="true"
                                    multiple required>
                                    ...
                                    <option value="software_development" @selected(in_array('software_development', old('department', [])))>Software Development</option>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                ...
                                <select name="supervisor_id" class="form-select form-select-solid" data-control="select2"
                                    data-placeholder="Select a Supervisor" data-allow-clear="true" required>
                                    <option></option>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" name="city" value="{{ old('city') }}" class="form-control form-control-solid" placeholder="Enter City">
                            </div>
                        </div>
                        <!-- Profile Picture -->
                        <div class="col-lg-4 col-md-6">
...
<div class="modal fade" id="adminEditModal-{{ $admin->id }}" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="border-0 shadow-sm modal-content rounded-3">
            ...
            <form method="POST" action="{{ route('admin.employee.update', $admin->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control form-control-solid" name="designation"
                                value="{{ $admin->designation }}" placeholder="Enter designation" maxlength="50" />
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <select name="employee_category_id" class="form-select form-select-solid"
                                data-control="select2" data-placeholder="Select job category" data-allow-clear="true">
                                <option></option>
                                @foreach ($employeeCategories as $employeeCategory)
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <select name="supervisor_id" class="form-select form-select-solid"
                                data-control="select2" data-placeholder="Select supervisor" data-allow-clear="true"
                                required>
                                <option></option>
                                @foreach ($admins as $supervisor)
