                                ...
                                <div class="col-lg-3">
                                    <div class="fv-row mb-3">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="brand_id[]"
                                            ...
                                            @php
                                                // FIX: Use $content instead of $product
                                    ...
                                    @php
                                        // FIX: Use $content instead of $product
                                        $categoryIds = isset($content->category_id) && is_string($content->category_id)
                                            ? json_decode($content->category_id, true) ?? []
                                            : [];
                                    @endphp
                                    ...
                                    <div class="fv-row mb-3 mt-1">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="industry_id[]"
                                            ...
                                            multiselect-max-items="2">
                                            @php
                                                $industryIds = isset($content->industry_id) && is_string($content->industry_id)
                                    ...
                                    <div class="fv-row mb-3 mt-1">
                                        ...
                                        <select class="form-select form-select-solid form-select-sm" name="solution_id[]"
                                            ...
                                            multiselect-max-items="2">
                                            @php
                                                $solutionIds = isset($content->solution_id) && is_string($content->solution_id)
