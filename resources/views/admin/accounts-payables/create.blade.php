        ...
        <div class="py-5 col-md-12">
            <div class="py-5 card h-100">
                <div class="py-5 card-header">
                    <h3 class="mb-0">Create Accounts Payable</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.accounts-payables.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="px-5 btn btn-primary me-3">Create Payable</button>
                        <a href="{{ route('admin.accounts-payables.index') }}" class="px-5 btn btn-secondary">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
